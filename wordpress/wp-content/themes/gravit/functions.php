...
function gravit_admin_notice() {
    ...
    <strong>If you are enjoying gravit you might want to check out our other themes at <a target="_blank" href="https://tryand.net/">tryand.net</a></strong></p>  <a class="skip button-primary" href="%1$s">Hide Notice</a>'), '?gravit_nag_ignore=0');
        echo "</p></div>";
	}
}
